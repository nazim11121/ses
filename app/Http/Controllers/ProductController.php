...
class ProductController extends Controller
{
    public function home()
    {
        ...
        $newArrivals = Product::with('category')->where('active', true)->orderBy('created_at', 'desc')->take(6)->get();
        $featuredProducts = Product::with('category')->where('active', true)->where('stock', '>', 20)->orderBy('created_at', 'desc')->take(6)->get();
        $topRatedProducts = Product::with('category')->where('active', true)->orderBy('stock', 'desc')->take(6)->get();
